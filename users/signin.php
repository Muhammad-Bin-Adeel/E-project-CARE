<?php
// Error reporting enable karein
ini_set('display_errors', 1);
error_reporting(E_ALL);

// Database connection
$conn = new mysqli("localhost", "root", "", "care2");
...
<!-- huzaifa yeh wo code hai jab user agar direct appointment lete hai to yeh function us phele sigin karne bole ga  -->
<?php
// session_start();
// if (!isset($_SESSION['username'])) {
//     header("Location: signin.php?message=please_login");
//     exit();
// }
?>
...
//     echo "<p style='color:red;'>پہلے سائن ان کریں، اس کے بعد اپوائنٹمنٹ لے سکتے ہیں۔</p>";
// }
?>
